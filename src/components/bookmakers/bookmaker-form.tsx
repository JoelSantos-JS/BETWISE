...
const bookmakerSchema = z.object({
  ...
  initialBankroll: z.coerce.number().min(0, "A banca inicial nao pode ser negativa."),
  currentBalance: z.coerce.number().min(0, "O saldo atual nao pode ser negativo."),
});
  ...
  const form = useForm<z.infer<typeof bookmakerSchema>>({
    ...
    defaultValues: bookmakerToEdit
      ? {
          ...
          currentBalance: bookmakerToEdit.currentBalance ?? bookmakerToEdit.initialBankroll,
        }
      : {
          name: "",
          initialBankroll: 0,
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="Ex: Bet365" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <DialogFooter className="p-6 pt-4 border-t">
            ...
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? <Loader2 className="animate-spin" /> : bookmakerToEdit ? "Salvar Alteracoes" : "Adicionar Casa"}
            </Button>
          </DialogFooter>
        </form>
      </Form>
